"""
===========================================================================================
Neural Dense Model Building Class
===========================================================================================
...
class XNeuralFeedForward(XModel):
    def init(self) -> bool:
    ...
    def fit(self, data_input=None, data_target=None, input_var_dict=None, target_var_dict=None, target_cat_dict=None):
        ...
        X = self.convert_input_dataframe_to_tensors(dataframe=data_input, input_var_dict=input_var_dict, type="static")
