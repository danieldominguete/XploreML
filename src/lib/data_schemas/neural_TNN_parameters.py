"""
===========================================================================================
Neural Transformers Model Building Parameters Class
===========================================================================================
Script by COGNAS
===========================================================================================
"""
...
class XNeuralTransformerParameters(BaseModel):

    # framework implementation
    framework: Frameworks = "tensorflow"

    # recurrent topology id
    topology_id: Topology = "TNN-TRANSx-FCCx"

    # transformer topology details
